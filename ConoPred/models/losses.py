...
eos = 21
'''
The calculation of the loss part comes from the reference 
"Das P, Sercu T, Wadhawan K et al. Accelerated antimicrobial discovery via deep
generative models and molecular dynamics simulations, Nature Biomedical
Engineering 2021;5:613-623."
'''
