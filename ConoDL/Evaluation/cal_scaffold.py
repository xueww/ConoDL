...
def process_toxin_file(input_file, output_file):
    toxin_data = []
    with open(input_file, 'r') as file:
        for line in file:
            toxin_sequence = line.strip()
            ...
            toxin_data.append((toxin_sequence, length, scaffold, scaffold_type, cysteine_count))

    with open(output_file, 'w') as file:
        file.write("toxin_sequence,length,scaffold,scaffold_type,cysteine_count")
        file.write("\n")
        for toxin_sequence, length, scaffold, scaffold_type, cysteine_count in toxin_data:
            file.write(str(toxin_sequence))
            file.write(",")
            file.write(str(length))
            file.write(",")
            file.write(str(scaffold))
            file.write(",")
            file.write(str(scaffold_type))
            file.write(",")
            file.write(str(cysteine_count))
            file.write("\n")


process_toxin_file('input_sequence.txt', 'output_scaffold.txt')