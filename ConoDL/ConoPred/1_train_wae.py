...
from models.data_processing.utils import Dataset, anneal
import os
...
dataset = Dataset('./dataset/train_wae.txt', 75)
train_batches = data.DataLoader(dataset, batch_size=batch_size, shuffle=True, drop_last=True, num_workers=0)
device = 'cuda:0'
model = RNN_VAE(vocab_size=paramters.vocab_size, max_seq_len=70, device=device,
